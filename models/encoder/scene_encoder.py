"""Polyline-based scene context encoder."""
...
from models.layers.transformer import transformer_encoder_layer, position_encoding_utils
from models.layers import polyline_encoder
