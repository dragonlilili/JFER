"""Joint two-agent decoding and world-conditioned reasoning."""
...
class JointReasoningCore(nn.Module):
    ...
    def _selection_signature(self, trajs):
        ...
        if self.multihorizon_joint_nms:
            ...
            # This reduces to final-endpoint distance when H=1.
    ...
    def _guarded_expansion_indices(
        ...
        *,
        ...
        Optional arguments allow evaluation-time policy overrides while
        preserving the trained candidate scores.
        """
